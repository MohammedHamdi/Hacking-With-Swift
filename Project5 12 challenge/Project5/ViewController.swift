...
class ViewController: UITableViewController {
    ...
    func load() {
        ...
        titleWord = defaults.object(forKey: "title") as? String ?? ""
        if titleWord == "" {
            startGame()
            return
        } else {
        ...
        if let savedWords = defaults.object(forKey: "usedWords") as? Data {
            ...
            do {
                ...
                print("Failed to load the words array.")
            }
        }
    }
}
